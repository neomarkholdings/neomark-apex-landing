...
**Samurai** (`/samurai`) is the Ronin Softworx local EDR desktop app (Tauri). Run it with `cd samurai && npm run desktop`. Ship installers via the **Samurai release** GitHub Action (`samurai-v*` tags). See [`samurai/README.md`](samurai/README.md).
